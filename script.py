...
def main():
    ...
    parser.add_argument("input_file", nargs='?', default="./data.json", help="Input JSON file (default: data.json)")
    parser.add_argument("output_file", nargs='?', default="./classified1_data.json", help="Output JSON file (default: classified_data.json)")
